class SiteHeader extends HTMLElement {
  connectedCallback() {
    ...
    const isAnimationsSection = current === 'anim1' || current === 'anim2' || current === 'anim3' || current === 'anim4' || current === 'anim5' || current === 'anim6' || current === 'anim7' || current === 'anim8' || current === 'anim9' || current === 'anim10';
